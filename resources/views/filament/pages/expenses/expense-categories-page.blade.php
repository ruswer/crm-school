<x-filament::page>
    <div class="flex flex-col lg:flex-row gap-4">
        ...
        <div class="w-full lg:w-[30%] bg-white rounded-lg shadow-sm p-4">
            <h2 class="text-lg font-medium text-gray-900 mb-4 pb-4 border-b">Kategoriya qo'shish</h2>
            <form class="space-y-4">
                <!-- Kategoriya nomi -->
                <div>
                    <label for="category_name" class="block text-sm font-medium text-gray-700">Kategoriya nomi</label>
        ...
        <div class="w-full lg:w-[70%] bg-white rounded-lg shadow-sm p-4">
            <h2 class="text-lg font-medium text-gray-900 mb-4 pb-4 border-b">Kategoriyalar ro'yhati</h2>
                ...
                <table class="min-w-full text-left text-sm whitespace-nowrap">
                    ...
                    <tbody>
                        <tr class="border-b dark:border-neutral-600">
                            <td class="px-6 py-4">
                                <span class="text-gray-900">Jihozlar</span>
                            </td>
                            <td class="px-6 py-4">utkazish kerak edi</td>
                            <td class="px-6 py-4">faol</td>
                            <td class="px-6 py-4">
                                <a href="#" 
