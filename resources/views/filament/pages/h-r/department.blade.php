<x-filament::page>
    <div class="flex flex-col lg:flex-row gap-4">
        ...
        <div class="w-full lg:w-[30%] bg-white dark:bg-gray-800 rounded-lg shadow-sm p-4 h-fit">
            <h2 class="text-lg font-medium text-gray-900 dark:text-gray-100 mb-4 pb-4 border-b dark:border-gray-700">Bo'lim qo'shish</h2>
            <form wire:submit.prevent="createDepartment" class="space-y-4">
                ...
                <div class="flex justify-end pt-4">
                    <button type="submit"
                        ...
                        <svg wire:loading wire:target="createDepartment" class="animate-spin -ml-1 mr-3 h-5 w-5 text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
        ...
        <div class="w-full lg:w-[70%] bg-white dark:bg-gray-800 rounded-lg shadow-sm p-4">
            <h2 class="text-lg font-medium text-gray-900 dark:text-gray-100 mb-4 pb-4 border-b dark:border-gray-700">Bo'limlar ro'yxati</h2>
            ...
            <div class="overflow-x-auto">
                ...
                <table class="min-w-full text-left text-sm whitespace-nowrap divide-y divide-gray-200 dark:divide-white/10">
                    ...
                    <tbody class="divide-y divide-gray-200 dark:divide-white/10">
                        ...
                        <tr wire:key="department-{{ $department->id }}" class="hover:bg-gray-50 dark:hover:bg-white/5">
                            <td class="px-6 py-4 text-gray-900 dark:text-white">{{ $department->name }}</td>
                            <td class="px-6 py-4 text-right">
                                <div class="flex items-center justify-end gap-2">
                                    <!-- Tahrirlash -->
                                    <button type="button" wire:click="openModal('edit', {{ $department->id }})"
                                            title="Tahrirlash"
                                    ...
                                    <!-- O'chirish -->
                                    <button type="button" wire:click="openModal('delete', {{ $department->id }})"
                                            title="O'chirish"
                            ...
                            <tr>
                                <td colspan="2" class="px-6 py-12 text-center text-gray-500 dark:text-gray-400">
                                    <div class="flex flex-col items-center justify-center">
                                        ...
                                        <p class="mt-2 text-sm font-medium">Bo'limlar topilmadi</p>
            ...
            >
                <div class="flex justify-between items-center pb-3 border-b dark:border-gray-700">
                    <h3 class="text-lg font-medium leading-6 text-gray-900 dark:text-gray-100">
                        <span x-text="$wire.modalType === 'edit' ? 'Bo\'limni tahrirlash' : 'Bo\'limni o\'chirish'"></span>
                    </h3>
                ...
                <div class="mt-4">
                    <div x-show="$wire.modalType === 'edit'">
                        <form wire:submit.prevent="updateDepartment" class="space-y-4">
                            <div>
                                <label for="editName" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Bo'lim nomi</label>
                            ...
                            <div class="mt-6 flex justify-end gap-x-3">
                                ...
                                <button type="submit" wire:loading.attr="disabled" wire:target="updateDepartment" class="inline-flex items-center justify-center rounded-lg border border-transparent bg-blue-600 px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 disabled:opacity-50">
                                    <svg wire:loading wire:target="updateDepartment" class="animate-spin -ml-1 mr-3 h-5 w-5 text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                                        <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
                                        <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
                                    </svg>
                                    Saqlash
                    ...
                    <div x-show="$wire.modalType === 'delete'" class="space-y-4">
                        <div class="flex items-start space-x-3">
                            ...
                            <div class="flex-1">
                                <h3 class="text-lg font-semibold text-gray-900 dark:text-gray-100">Bo'limni o'chirish</h3>
                                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                                    Rostdan ham "<span class="font-medium">{{ $departmentToDeleteName }}</span>" bo'limini o'chirmoqchimisiz? Bu amalni ortga qaytarib bo'lmaydi.
                                </p>
                            </div>
                        </div>
                        <div class="mt-6 flex justify-end gap-x-3">
                            ...
                            <button type="button" wire:click="deleteDepartment" wire:loading.attr="disabled" wire:target="deleteDepartment" class="inline-flex justify-center items-center rounded-lg border border-transparent bg-red-600 px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 disabled:opacity-50">
                                <svg wire:loading wire:target="deleteDepartment" class="animate-spin -ml-1 mr-3 h-5 w-5 text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                                    <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
                                    <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
                                </svg>
                                O'chirish
