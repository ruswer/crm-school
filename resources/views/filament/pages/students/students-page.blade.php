                ...
                <table class="min-w-full text-left text-sm whitespace-nowrap">
                    ...
                    <tbody>
                        <tr class="border-b dark:border-neutral-600">
                            ...
                            <td class="px-6 py-4">SMM</td>
                            <td class="px-6 py-4">Guruh A</td>
                            <td class="px-6 py-4">+998 90 123 45 67</td>
                            <td class="px-6 py-4">Ingliz tili</td>
                            <td class="px-6 py-4">Elementary</td>
                            <td class="px-6 py-4">Du/Chor/Juma</td>
                            <td class="px-6 py-4">
                                <a href="#" 
