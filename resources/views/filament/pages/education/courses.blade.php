<x-filament::page>
    <div class="flex flex-col lg:flex-row gap-4">
        ...
        <div class="w-full lg:w-[30%] bg-white rounded-lg shadow-sm p-4">
            <h2 class="text-lg font-medium text-gray-900 mb-4 pb-4 border-b">Kurs qo'shish</h2>
            <form class="space-y-4">
                <!-- Kurs nomi -->
                <div>
                    <label for="course_name" class="block text-sm font-medium text-gray-700">Kurs</label>
        ...
        <div class="w-full lg:w-[70%] bg-white rounded-lg shadow-sm p-4">
            <h2 class="text-lg font-medium text-gray-900 mb-4 pb-4 border-b">Kurslar ro'yxati</h2>
                    ...
                    <table class="min-w-full text-left text-sm whitespace-nowrap">
                        <thead class="uppercase tracking-wider border-b-2 dark:border-neutral-600 bg-gray-100 text-gray-800">
                            <tr>
                                <th scope="col" class="px-6 py-4">
                                    <div class="flex items-center gap-x-1 cursor-pointer group" @click="sort('courseName')">
                                        <span>Kurs nomi</span>
                        ...
                        <tbody>
                            ...
                            <tr class="border-b dark:border-neutral-600">
                                <td data-field="courseName" class="px-6 py-4">ingliz tili</td>              
                                <td class="px-6 py-4">
                            ...
                            <tr class="border-b dark:border-neutral-600">
                                <td data-field="courseName" class="px-6 py-4">arab tili</td>
                                <td class="px-6 py-4">
                                    <div class="flex items-center gap-2">
                                        <!-- Tahrirlash -->
                                        <a href="#" class="text-blue-600 hover:text-blue-900">
